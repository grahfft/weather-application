...
{
    public WeatherForecast(string unit, double lat, double lon, bool rainPossibleToday)
    {
        this.Unit = unit;
        this.Lat = lat;
        this.Lon = lon;
...
{
    public CurrentForecast(int currentTemperature, string unit, double lat, double lon, bool rainPossibleToday)
        : base(unit, lat, lon, rainPossibleToday)
    {
